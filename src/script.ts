...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const menulist = document.querySelector('.menulist') as HTMLElement | null;
    ...
    if (contactForm) {
        ...
        const emailFormGroup = contactForm.querySelector('.email-form-group') as HTMLElement;
        ...
        contactForm.addEventListener('submit', (event) => {
            ...
            const submitButton = (contactForm as HTMLFormElement).querySelector('button[type="submit"]') as HTMLButtonElement;
            const originalButtonText = submitButton.textContent;
            submitButton.textContent = 'Sending...';
            submitButton.disabled = true;

            emailjs.sendForm('service_0rwuxsb', 'template_3sque6w', contactForm as HTMLFormElement)
                .then(() => {
